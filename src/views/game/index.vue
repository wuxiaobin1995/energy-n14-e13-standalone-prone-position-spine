 ...
 * @LastEditTime: 2023-03-09 15:45:07
 * @Description : 游戏
-->
<template>
  <div class="game">
  ...
  methods: {
    ...
    handlePlay() {
      ...
      const data = JSON.stringify({
        ...
        exe_path:
          'C:/Program Files/energy-n14-e13-standalone-prone-position-spine/卧姿肢体医用康复训练系统-单机版.exe' // 自己程序的绝对路径
      })

      /* 使用fs库写文件 */
      const dirPath = `C:/game_data.txt` // 测试用D盘，打包记得改回C盘
