<!--
 * @Author      : Mr.bin
 * @Date        : 2023-06-06 14:00:36
 * @LastEditTime: 2023-06-06 14:04:40
 * @Description : 内核心激活训练-pdf子组件
-->
<template>
  <div class="plan-stabilizer-activation-pdf">
    <div class="chart">
      <div
        id="stabilizer-activation-chart"
...
<script>
export default {
  name: 'plan-stabilizer-activation-pdf',
  ...
  methods: {
    ...
    initChart() {
      this.myChart = this.$echarts.init(
        document.getElementById('stabilizer-activation-chart')
      )
      this.option = {
        xAxis: {
          type: 'category',
        ...
        yAxis: {
          ...
          min: this.data.targetDown - 3 >= 0 ? this.data.targetDown - 3 : 0,
          max: this.data.targetUp + 3 <= 100 ? this.data.targetUp + 3 : 100
        },
        legend: {},
        series: [
          {
...
.plan-stabilizer-activation-pdf {
  width: 100%;
  height: 60%;
  padding: 10px;
