<!--
 * @Author      : Mr.bin
 * @Date        : 2023-06-05 20:43:00
 * @LastEditTime: 2023-06-05 20:50:30
 * @Description : 方案-动态稳定训练-参数设置
-->
<template>
  <div class="plan-dynamic-set">
    <div class="wrapper">
      <!-- 文字说明 -->
      <div class="des">
  ...
  methods: {
    ...
    handleRefresh() {
      this.$router.push({
        path: '/refresh',
        query: {
          routerName: JSON.stringify('/plan-dynamic-set'),
