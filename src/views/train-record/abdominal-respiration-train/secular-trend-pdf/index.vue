 ...
 * @LastEditTime: 2022-03-05 18:41:40
 * @Description : 腹式呼吸训练-长期趋势报告
-->
<template>
  <div
    class="abdominal-respiration-train-secular-trend-pdf"
  ...
  methods: {
    ...
    getData() {
      ...
      this.$axios
        ...
        .catch(err => {
          this.$confirm(
            `[腹式呼吸训练-长期趋势报告环节] ${err}。请确保网络连接正常，然后重试！`,
            '网络请求错误',
            {
              type: 'error',
              center: true,
...
.abdominal-respiration-train-secular-trend-pdf {
  width: 100%;
  height: 100%;
