 ...
 * @LastEditTime: 2022-03-05 18:40:50
 * @Description : 灵活性测试-长期趋势报告
-->
<template>
  <div
    class="flexibility-test-secular-trend-pdf"
    v-loading.fullscreen.lock="fullscreenLoading"
  >
    <!-- PDF区域 -->
    <div id="pdf" class="pdf-wrapper">
      <div class="up">
        <div class="title">灵活性测试-长期趋势报告</div>
        <div class="logo-img">
...
export default {
  ...
  methods: {
    ...
    handlePrint() {
      this.$htmlToPdf(
        'pdf',
        `灵活性测试-长期趋势报告 ${this.$moment().format(
          'YYYY-MM-DD HH_mm_ss'
        )}`
      )
    },
...
.flexibility-test-secular-trend-pdf {
  width: 100%;
  height: 100%;
