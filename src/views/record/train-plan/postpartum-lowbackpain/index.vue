 ...
 * @Description : 产后腰痛-数据记录
-->
<template>
  <div class="train-plan-postpartum-lowbackpain-record">
    <!-- 顶部 -->
    <div class="top">
      <!-- 标题 -->
      <el-page-header
      ...
      this.$router.push({
        ...
        query: {
          ...
          routerName: JSON.stringify(
            '/train-plan-record/postpartum-lowbackpain'
          )
        }
      })
    },
...
.train-plan-postpartum-lowbackpain-record {
  width: 100%;
  height: 90%;
