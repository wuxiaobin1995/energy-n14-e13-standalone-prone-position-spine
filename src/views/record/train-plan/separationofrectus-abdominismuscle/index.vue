...
-->
<template>
  <div class="train-plan-separationofrectus-abdominismuscle-record">
    <!-- 顶部 -->
    <div class="top">
      <!-- 标题 -->
      <el-page-header
      ...
      this.$router.push({
        ...
        query: {
          ...
          routerName: JSON.stringify(
            '/train-plan-record/separationofrectus-abdominismuscle'
          )
        }
      })
    },
...
.train-plan-separationofrectus-abdominismuscle-record {
  width: 100%;
  height: 90%;
