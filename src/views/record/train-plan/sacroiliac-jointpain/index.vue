 ...
 * @LastEditTime: 2023-06-05 21:45:06
 * @Description : 骶髂关节痛-数据记录
-->
<template>
  <div class="train-plan-sacroiliac-jointpain-record">
    <!-- 顶部 -->
    <div class="top">
      <!-- 标题 -->
      <el-page-header
    ...
    handleToPdf(index, row) {
      this.$router.push({
        ...
        query: {
          ...
          routerName: JSON.stringify('/train-plan-record/sacroiliac-jointpain')
        }
      })
    },
...
.train-plan-sacroiliac-jointpain-record {
  width: 100%;
  height: 90%;
