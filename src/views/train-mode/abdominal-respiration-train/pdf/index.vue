<!--
 * @Author      : Mr.bin
 * @Date        : 2021-12-01 16:28:19
 * @LastEditTime: 2022-03-05 18:41:01
 * @Description : 腹式呼吸训练-PDF报告
-->
<template>
  <div
    class="abdominal-respiration-train-pdf"
  ...
  methods: {
    ...
    getData() {
      ...
      this.$axios
        ...
        .catch(err => {
          this.$confirm(
            `[腹式呼吸训练-PDF报告环节] ${err}。请确保网络连接正常，然后重试！`,
            '网络请求错误',
            {
              type: 'error',
              center: true,
    ...
    countChart() {
      return new Promise((resolve, reject) => {
        ...
        const target = this.pdfData.target // 目标
    ...
    initChart() {
      ...
      this.option = {
        ...
        yAxis: {
          ...
          min:
            this.pdfData.targetDown - 10 >= 0 ? this.pdfData.targetDown - 10 : 0
        },
        legend: {},
        // tooltip: {},
        series: [
...
.abdominal-respiration-train-pdf {
  width: 100%;
  height: 100%;
