<!--
 * @Author      : Mr.bin
 * @Date        : 2021-12-03 11:35:47
 * @LastEditTime: 2022-03-05 18:41:31
 * @Description : 静态训练-PDF报告
-->
<template>
  <div class="static-train-pdf" v-loading.fullscreen.lock="fullscreenLoading">
    <!-- PDF区域 -->
  ...
  methods: {
    ...
    getData() {
      ...
      this.$axios
        ...
        .catch(err => {
          this.$confirm(
            `[静态训练-PDF报告环节] ${err}。请确保网络连接正常，然后重试！`,
            '网络请求错误',
            {
              type: 'error',
              center: true,
